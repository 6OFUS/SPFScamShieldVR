...
+ [Sounds good! What do I need to do?] -> job_offer_reply_1
+ [Can I know more about how it works?] -> job_offer_reply_1
+ [Is this a freelance role or official employment?] -> job_offer_reply_2
...
+ [Do I need to spend money to start?] -> job_task_reply_1
...
+ [Sounds good, I'd like to know how the tasks work.] -> job_offer_reply_1 
+ [Can I verify this role through your official site or company HR?] -> job_verification_reply_1
+ [Screenshot and submit to ScamShield.] -> report_scamshield
...
=== job_task_reply_1 === 
That's a great question - and totally understandable. <br><br> You're not paying us anything. The system simply requires that new users complete a purchase cycle, which simulates a real transaction.<br><br>For example, a group may ask you to cart or wishlist 3 items, costing around $25-$40. Once you complete the group, the platform returns the amount along with your commission, directly to your balance.<br><br>This helps confirm your account isn't a bot and ensures smooth payout tracking.

+ [Okay, that makes sense. I'll give it a try.] -> complete_tasks
+ [Can I start without doing a purchase cycle?] -> job_task_reply_2
+ [Screenshot and submit to ScamShield.] -> report_scamshield
...
+ [Okay, that makes sense. I'll give it a try.] -> complete_tasks
+ [Can you guarantee I'll get the money back after the task?] -> job_task_reply_3
+ [Screenshot and submit to ScamShield.] -> report_scamshield

=== job_task_reply_3 ===
Yes, absolutely - the system is automated and built to credit both your task amount and commission immediately after each completed group. <br><br>For example, if your task cycle involves $25, your balance will show $28.25 right after. <br><br>We've processed over 2,000 contributor payouts this month alone, and all successful applicants receive their earnings as long as tasks are completed correctly. If you face any delay, our support team is available 24/7 to help. 

+ [Alright, I'll go ahead with the task.] -> complete_tasks
+ [Can I see a sample payout proof before I continue?] -> job_task_reply_4
+ [Screenshot and submit to ScamShield.] -> report_scamshield

=== job_task_reply_4 === //SENDING OF PROOF
//image sent
Scammer sends proof
+ [Alright, I'll go ahead with the task.] -> complete_tasks
+ [Screenshot and submit to ScamShield.] -> report_scamshield
...
//------------------------------ JOB VERIFICATION ------------------------------
=== job_verification_reply_1 ===
Absolutely, I understand the importance of verification. Our contributor recruitment is handled through a private onboarding system under our vendor management team, so this specific role isn't listed on our public site. But I can get someone from our admin team to follow up with a confirmation email, if needed. <br><br>Meanwhile, if you'd like, I can walk you through the process step-by-step here.

+ [Okay, I'll proceed with your help here first.] -> job_task_reply_1
+ [Yes, please ask them to email me first. I'll wait for the confirmation.] -> job_verification_reply_2
+ [Screenshot and submit to ScamShield.] -> report_scamshield

=== job_verification_reply_2 === //EMAIL VERIFICATION
//email sent, need open app
+ [Okay, I have received the email.] -> job_task_reply_1
+ [Screenshot and submit to ScamShield.] -> report_scamshield
