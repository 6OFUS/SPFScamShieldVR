/*
    Author: https://assetstore.unity.com/packages/2d/gui/icons/simple-spinner-progress-indicators-for-ui-237500
    Date: 24/06/2025
    Description: The SimpleSpinner class is used for the loading animation
*/
using UnityEngine;
...
namespace Assets.SimpleSpinner
{
    ...
    public class SimpleSpinner : MonoBehaviour
    {
        ...
        public void Update()
        {
            if (Rotation)
            {
                transform.localEulerAngles = new Vector3(90, 0, -360 * RotationAnimationCurve.Evaluate((RotationSpeed * Time.time + _period) % 1));
            }
